    ...
    <div className="project-card">
      <div className={`flex flex-col ${isReversed ? 'md:flex-row-reverse' : 'md:flex-row'} gap-8`}>
        <div className="w-full md:w-1/2">
          <p className="text-theme-highlight font-medium mb-2">PROJECT {number}</p>
          <h3 className="text-2xl font-bold mb-4">{title}</h3>
          <p className="text-white/80 mb-6">{description}</p>
          
          <Button variant="ghost" className="p-0 flex items-center gap-2 text-theme-highlight group">
            <span>Read more</span>
